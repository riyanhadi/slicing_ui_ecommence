...
class QColorPicker extends StatefulWidget {
  ...
  @override
  State<QColorPicker> createState() => _QColorPickerState();
}

class _QColorPickerState extends State<QColorPicker> {
  int selectedIndex = -1;
  ...
  updateIndex(newIndex) {
    ...
    widget.onChanged(index, value, value, item);
  }
